...
import json
import sys
from get_entities_by_rand_id import *

def get_entities_in_random(reactome_id):
  ...
  return get_entities_by_rand_id(','.join(entity_ids))

if '__main__' == __name__:
  pathway_id = sys.argv[1]
  print(json.dumps(get_entities_in_random(pathway_id)))
